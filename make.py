    ...
    if (docker_image_exists(build_image_name)):
        if (docker_container_exists(build_container_name)):
            ...
            check_call([
                ...
                '-v', "{}:/root/clang-llvm/llvm/tools/clang/tools/extra/{}"
                .format(working_dir.as_posix(), project_name),
                build_image_name,
                "/root/clang-llvm/llvm/tools/clang/tools/extra/{}/Docker/docker-build.sh"
                .format(project_name)
        ...
        raise Exception("{} Docker image not found. Run 'docker build -t {} .' first."
            .format(build_image_name, build_image_name)
        )
